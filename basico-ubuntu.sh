...
git clone https://github.com/Brigibel12/practica4-Brigibel.git && cd practica4-Brigibel
...
java -jar ~/practica4-Brigibel/app1/build/libs/app.jar > ~/practica4-Brigibel/app1/build/libs/salida.txt 2> ~/practica4-Brigibel/app1/build/libs/error.txt &
...
# Subiendo la aplicación puerto por defecto.
java -jar ~/practica4-Brigibel/app2/build/libs/app.jar > ~/practica4-Brigibel/app2/build/libs/salida.txt 2> ~/practica4-Brigibel/app2/build/libs/error.txt &
